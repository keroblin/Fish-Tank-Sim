...
namespace SerializeTools
{
    [System.Serializable]
    [SerializeField]
    public class SerializeableVec3
    {
        public float x;
        public float y;
        public float z;
        public SerializeableVec3(Vector3 vec3)
        {
            this.x = vec3.x;
            this.y = vec3.y;
            this.z = vec3.z;
    ...
    public class SerializeableQuaternion
    {
        ...
        public float z;
        public float w;
        public SerializeableQuaternion(Quaternion quat)
        {
            this.x = quat.x;
            this.y = quat.y;
            this.z = quat.z;
        ...
        {
            Quaternion result = new Quaternion(this.x, this.y, this.z,this.w);
            return result;
        }
    }
    [System.Serializable]
    ...
    {
        public SerializeableVec3 position;
        public SerializeableQuaternion rotation;
        public SerializeableTransform(Transform transform)
        {
            this.position = new SerializeableVec3(transform.position);
            this.rotation = new SerializeableQuaternion(transform.rotation);
        }
    }

    /// <summary>
    /// I didn't do this bit! Below is the amazing open source source by vexe on the Unity forums
    ...
    public class SerializeableDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        {
            private readonly SerializeableDictionary<TKey, TValue> _Dictionary;
            ...
            internal Enumerator(SerializeableDictionary<TKey, TValue> dictionary)
            {
